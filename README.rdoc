...
Instead of parsing these yourself, the <code>date_time</code> method will convert the 
date and time strings into a DateTime object with the timezone set to UTC.
